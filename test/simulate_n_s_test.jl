...
s1 = simulate_n_s(θ_true; simulator = deterministic_test_simulator, n_sim=10)
s2 = simulate_n_s(θ; simulator = deterministic_test_simulator)
...
sim(θ) = deterministic_test_simulator([θ[1], 10])

simulate_n_s([1.]; simulator = sim, n_sim = 10) ==
